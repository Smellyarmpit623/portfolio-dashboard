...
if __name__=="__main__" :
    ...
    new10=instrument(ticker="TMF",qty=50,cost_price=1.479,chinese_name="三倍做多20年期美国国债收益率指数",option=True,option_ticker="TMF250117C00010000",expirationDate='2025-01-17',strike=10,direction="看涨期权")

...
if __name__=="__main__" :
    ...
    new1=instrument(ticker="SOXL",qty=50,cost_price=6.753,chinese_name="三倍做多半导体",option=True,option_ticker="SOXL250117C00040000",expirationDate='2025-01-17',strike=40,direction="看涨期权")
